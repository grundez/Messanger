...
# Project:  Server.pro
# Template: app
# Command: C:\Qt\6.5.1\mingw_64\bin\qmake.exe -o Makefile Server.pro -spec win32-g++ "CONFIG+=qtquickcompiler"
#############################################################################
...
Makefile: Server.pro C:/Qt/6.5.1/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.5.1/mingw_64/mkspecs/features/spec_pre.prf \
