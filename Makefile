#############################################################################
# Makefile for building: MessangerApp
# Generated by qmake (3.1) (Qt 6.5.1)
# Project:  MessangerApp.pro
# Template: app
# Command: C:\Qt\6.5.1\mingw_64\bin\qmake.exe -o Makefile MessangerApp.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: MessangerApp.pro C:/Qt/6.5.1/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.5.1/mingw_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile MessangerApp.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
